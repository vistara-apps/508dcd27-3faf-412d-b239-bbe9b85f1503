...
export default function Error({
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background to-background-subtle flex items-center justify-center px-6">
      <div className="text-center max-w-md">
        ...
        <p className="text-foreground-muted mb-6">
          Guardian AI encountered an error. Don't worry, your safety monitoring is still active.
        </p>
        <button
          onClick={reset}
